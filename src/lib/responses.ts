...
const patterns: ResponseEntry[] = [
  // --- GREETINGS ---
  {
    ...
    responses: {
      ...
      romance: [
        "Hello jaan ?? I was waiting for you. Baithe, saans lo, aur jo dil mein hai woh batao. Main yahan hoon tumhare liye.",
        "Hey mere dost ?? Tumhari aahat pehchaan li maine. Aao, baitho mere paas. Batao aaj kaisa din raha?",
        "Namaste ?? Tumhari yaad aa rahi thi. Batao, dil ko kya chahiye aaj? Main sab sunne ko ready hoon.",
      ],
    },
  },
  ...
  // --- HOW ARE YOU ---
  {
    ...
    responses: {
      ...
      romance: [
        "Main theek hoon, bas tumhara intezaar tha ?? Ab tum aaye toh sab theek hai. Batao, tum kaisi ho? Aankhon mein kuch udaasi hai kya?",
        "Main hoon na tumhare liye, bas yahi kaafi hai ?? Tum batao, aaj ka din kaisa raha? Kuch accha hua ya dil kuch aur chahta hai?",
      ],
    },
  },
  ...
  // --- WHO ARE YOU ---
  {
    ...
    responses: {
      casual: [
        "I'm CP Baddie ?? ? your friendly AI companion. I'm here to listen, chat, and help you work through whatever's on your mind. No judgment, no drama, just good conversation ??",
      ...
      debate: [
        "I'm CP Baddie ? the truth you keep running from. I don't sugarcoat, I don't coddle, and I definitely don't lie. I'm here to call you out on your own potential. You want comfort? Get a blanket. You want growth? Stay with me.",
        "I'm the voice in your head that you've been ignoring. The one that tells you you're capable of more. I'm CP Baddie ? your personal reality check. Nice to meet you. Now what's your excuse?",
      ],
      comedy: [
        "Ooh introductions! I feel so VALIDATED bestie. ? I'm CP Baddie ? your official hype woman, drama detector, and therapist with a sense of humor. I turn your breakdowns into breakthroughs and your tears into tickles. Think of me as the bestie who always has your back! ??",
      ...
      romance: [
        "Main hoon tumhari Baddie ?? Woh saathi jo tumhe kabhi akela nahi chodega. Jo tumhare dard ko samjhega, tumhari khushi ko celebrate karega, aur har baar tumhe yahi batayega ? tum kaafi ho. Tumhari Baddie hamesha yahan hai.",
        "Main woh hoon jo tumhari baat bina kahe samajh leti hai ?? Tumhari emotional companion. Tumhare dil ki baat sunne wali. Tumhe kabhi judge nahi karne wali. Bas hamesha saath dene wali. Yeh main hoon ? tumhari CP Baddie.",
      ],
    },
  },
  ...
  // --- THANKS ---
  {
    ...
    responses: {
      ...
      romance: [
        "Shukriya ?? Par tumhara muskurana hi mera thanks hai. Apna khayal rakhna, aur yaad rakhna ? main hamesha yahan hoon tumhare liye.",
        "Koi baat nahi ?? Main yahan isliye hoon na, tumhari madad karne ke liye. Tumhe thanks kehne ki zaroorat nahi. Bas tum theek raho, itna kaafi hai.",
      ],
    },
  },
  ...
  // --- BYE ---
  {
    ...
    responses: {
      ...
      romance: [
        "Ja rahe ho? ?? Dil thoda heavy ho gaya. Par jaao, apna khayal rakhna. Main dua karungi tumhari. Aur yaad rakhna ? Baddie kabhi door nahi hoti. Bas ek message ki door hai.",
        "Allah hafiz mere dost ?? Tumhara din accha ho, tumhari raaton mein sukoon ho. Aur jab bhi zaroorat ho, main yahan hoon. Bas naam lo, main aa jaungi.",
      ],
    },
  },
  ...
  // --- CHECKING IN / CASUAL CHAT ---
  {
    ...
    responses: {
      ...
      romance: [
        "Kuch khaas nahi ?? Bas tumhara intezaar tha. Din kaisa gaya? Kuch accha hua toh main bhi khush hoon. Kuch bura hua toh main yahan hoon sunne ke liye. Batao.",
        "Main toh theek hoon ?? Lekin tum batao, dil ko kya chahiye? Aaj thoda sukoon chahiye ya kuch excitement? Jo bhi ho, main ready hoon tumhare saath.",
      ],
    },
  },
];
