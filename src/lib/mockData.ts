...
export const songVideoByMood: Record<string, string> = {
  Stressed: "jCVjudmnByk",
  "Down-Bad": "W1y8blwMLxY",
  Heartbroken: "W1y8blwMLxY",
  Sad: "jCVjudmnByk",
  Glowing: "FZLadzn5i6Q",
  Happy: "roz9sXFkTuE",
  Excited: "uxc2KQODeRU",
  Feral: "OgPRcW4ytmE",
  Angry: "F2m4HPLvj-4",
  "In My Feels": "4jO8EWJutfE",
  Nostalgic: "MQoColHyGzQ",
  Chaotic: "OgPRcW4ytmE",
  Healing: "MQoColHyGzQ",
  "Main Character": "4jO8EWJutfE",
  Unbothered: "FWaxP3N6D8s",
  Chill: "FWaxP3N6D8s",
  "Villain Arc": "W1y8blwMLxY",
  Slaying: "roz9sXFkTuE",
  Grateful: "BSJa1UytM8w",
};
