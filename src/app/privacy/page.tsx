  ...
  return (
    <div style={{ fontFamily: "system-ui, sans-serif", backgroundColor: "#0b0f19", color: "#f8fafc", minHeight: "100vh", padding: "40px 20px" }}>
      <div style={{ maxWidth: "700px", margin: "0 auto", background: "#151c2c", border: "1px solid #1e293b", borderRadius: "20px", padding: "40px" }}>
        ...
        <p>When you use CP Baddie, we collect:</p>
        ...
        <ul style={{ color: "#cbd5e1", lineHeight: "1.8" }}>
          ...
          <li>To show your personalized content</li>
          <li>To improve our services</li>
        </ul>

        <h2>Data Storage</h2>
        <p>Your data is stored securely on Neon PostgreSQL database. Chat messages are encrypted before storage.</p>
        ...
        <ul style={{ color: "#cbd5e1", lineHeight: "1.8" }}>
          ...
          <li><strong>YouTube API</strong> ? fetches video data</li>
        </ul>

        <h2>Your Rights</h2>
        <p>You can delete your chat history or your entire account at any time from the dashboard.</p>
